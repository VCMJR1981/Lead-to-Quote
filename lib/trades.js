export const TRADES = {
  plumber: {
    ...
    defaultItems: [
      { name: 'Labour (hourly)', qty: 2, unit_price: 70 },
  ...
  electrician: {
    ...
    defaultItems: [
      { name: 'Labour (hourly)', qty: 2, unit_price: 65 },
      { name: 'Call-out fee', qty: 1, unit_price: 50 },
  ...
  carpenter: {
    ...
    defaultItems: [
      { name: 'Labour (day rate)', qty: 1, unit_price: 280 },
      { name: 'Materials', qty: 1, unit_price: 0 },
  ...
  hvac: {
    ...
    defaultItems: [
      { name: 'Labour', qty: 1, unit_price: 200 },
  ...
  painter: {
    ...
    defaultItems: [
      { name: 'Labour (day rate)', qty: 1, unit_price: 250 },
  ...
  roofer: {
    ...
    defaultItems: [
      { name: 'Labour', qty: 1, unit_price: 0 },
      { name: 'Materials', qty: 1, unit_price: 0 },
  ...
  tiler: {
    ...
    defaultItems: [
      { name: 'Labour (per m²)', qty: 10, unit_price: 30 },
  ...
  landscaper: {
    ...
    defaultItems: [
      { name: 'Labour (day rate)', qty: 1, unit_price: 300 },
  ...
  handyman: {
    ...
    defaultItems: [
      { name: 'Labour (hourly)', qty: 2, unit_price: 45 },
  ...
  plasterer: {
    ...
    defaultItems: [
      { name: 'Labour (day rate)', qty: 1, unit_price: 260 },
  ...
  flooring: {
    ...
    defaultItems: [
      { name: 'Labour (per m²)', qty: 20, unit_price: 15 },
  ...
  locksmith: {
    ...
    defaultItems: [
      ...
      { name: 'Labour', qty: 1, unit_price: 60 },
  ...
  solar: {
    ...
    defaultItems: [
      ...
      { name: 'Labour & commissioning', qty: 1, unit_price: 600 },
    ],
  },
  pool: {
    ...
    defaultItems: [
      { name: 'Labour', qty: 2, unit_price: 60 },
  ...
  kitchen_bathroom: {
    ...
    defaultItems: [
      { name: 'Labour (day rate)', qty: 3, unit_price: 300 },
