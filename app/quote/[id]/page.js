        ...
        <div className="max-w-xl mx-auto flex items-center gap-4">
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-wrap gap-x-3 mt-1">
              ...
              {business?.email && (
                <a href={`mailto:${business.email}`} className="text-xs text-gray-600">{business.email}</a>
              )}
            </div>
            {business?.address && (
      ...
      <div className="max-w-xl mx-auto px-4 py-5 space-y-4 pb-36">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 p-5">
          <div className="flex justify-between items-start">
            <div>
              <p className="text-xs text-gray-600 uppercase tracking-wide mb-1">Quotation</p>
            ...
            <div className="text-right">
              ...
              {lead?.phone && <p className="text-xs text-gray-600">{lead.phone}</p>}
            </div>
          </div>
          <div className="flex gap-4 mt-3 pt-3 border-t border-gray-50 text-xs text-gray-600">
            ...
            {section.items.filter(i => i.name || i.unit_price).map(item => (
              <div key={item.id} className="px-4 py-3 flex justify-between items-start gap-4 border-b border-gray-50 last:border-0">
                <div className="flex-1">
                  ...
                  {item.qty !== 1 && (
                    <p className="text-xs text-gray-600 mt-0.5">{item.qty} × {fmt(item.unit_price)}</p>
                  )}
                </div>
              ...
              <div className="bg-gray-50 rounded-xl p-3">
                ...
                {business?.bank_detail ? (
                  <div className="bg-white rounded-lg p-3 border border-gray-200">
                    ...
                    <p className="text-xs text-gray-600 mt-2">Reference: {quote?.quote_number} · {lead?.name}</p>
            ...
            {paymentMethods.includes('cash') && (
              <div className="bg-gray-50 rounded-xl p-3 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600">Arrange directly with {business?.name}</p>
                </div>
              </div>
            )}
          </div>
        ...
        <div className="rounded-2xl p-4 bg-gray-50 border border-gray-200">
          <p className="text-xs font-semibold text-gray-600 uppercase tracking-wide mb-2">Important Notice</p>
        ...
        <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-100 p-4 pb-8">
          <div className="max-w-xl mx-auto">
            <div className="text-center mb-3">
              ...
              <p className="text-xs text-gray-600 mt-1">Choose how you'd like to pay the deposit below.</p>
            </div>
